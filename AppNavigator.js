...
import BoiledTimeSelectionScreen from './screens/BoiledTimeSelectionScreen';
  ...
  return (
    <NavigationContainer>
      ...
      >
        ...
        />
        <Stack.Screen
          name="BoiledTimeSelectionScreen"
          component={BoiledTimeSelectionScreen}
          options={{ title: 'boiledTimeSelection' }}
        />
      </Stack.Navigator>
    </NavigationContainer>
  );
